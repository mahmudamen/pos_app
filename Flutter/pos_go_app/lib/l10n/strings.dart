...
class AppStrings {
  ...
  String get invVoid => isArabic ? 'ملغاة' : 'Void';
  String get invRefunded => isArabic ? 'مستردة' : 'Refunded';
  String get createInvoice => isArabic ? 'إنشاء فاتورة' : 'Create invoice';
  String get amountLabel => isArabic ? 'المبلغ' : 'Amount';
  String get descriptionLabel => isArabic ? 'الوصف' : 'Description';
  String get provider => isArabic ? 'المزوّد' : 'Provider';
  String get dueAt => isArabic ? 'الاستحقاق' : 'Due date';
  String get pay => isArabic ? 'دفع' : 'Pay';
  String get voidInvoice => isArabic ? 'إلغاء' : 'Void invoice';
  String get noInvoices => isArabic ? 'لا توجد فواتير' : 'No invoices';
  String get mrr => isArabic ? 'الإيراد الشهري' : 'MRR';
  String get outstanding => isArabic ? 'المستحق' : 'Outstanding';
  ...
  String get userRole => isArabic ? 'الدور' : 'Role';
  ...
  String get ocrWindowMonth => isArabic ? 'الشهر' : 'This month';
  String get ocrCredits => isArabic ? 'رصيد الفحوصات' : 'Scan credits';
  ...
  String get applyPurchase => isArabic ? 'تطبيق المشتريات' : 'Apply purchase';
  String get ocrCartTotal => isArabic ? 'إجمالي المشتريات:' : 'Purchase total:';
  String get quantity => isArabic ? 'الكمية' : 'Qty';
  ...
  String get approvedLabel => isArabic ? 'مُوافَق عليه' : 'Approved';
  String get cancelledLabel => isArabic ? 'مُلغى' : 'Cancelled';
  String get openLabel => isArabic ? 'مفتوح' : 'Open';
  String get fulfilledLabel => isArabic ? 'تم التوفير' : 'Fulfilled';
  String get closedLabel => isArabic ? 'مغلق' : 'Closed';
  String pageLabel(int current, int total) =>
      isArabic ? 'الصفحة $current من $total' : 'Page $current of $total';

  String unitProfit(String amount) =>
      isArabic ? 'الربح للوحدة: $amount' : 'Profit/unit: $amount';
