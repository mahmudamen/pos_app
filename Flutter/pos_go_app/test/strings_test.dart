...
void main() {
  ...
  test('Arabic strings are provided for core labels', () {
    ...
    expect(ar.themeDark, 'داكن');
    expect(ar.themeSystem, 'تلقائي');
    expect(ar.accentColor, 'لون العلامة');
    expect(ar.themeBlue, 'أزرق');
    expect(ar.themeGreen, 'أخضر');
    expect(ar.themeOrange, 'برتقالي');
    expect(ar.themePurple, 'بنفسجي');
    expect(ar.themeTeal, 'تركوازي');
    expect(ar.themeCrimson, 'قرمزي');
    expect(ar.preview, 'معاينة');
  ...
  test('English strings are provided for core labels', () {
    ...
    expect(en.accentColor, 'Accent color');
    expect(en.themeBlue, 'Blue');
    expect(en.themeGreen, 'Green');
    expect(en.themeOrange, 'Orange');
    expect(en.themePurple, 'Purple');
    expect(en.themeTeal, 'Teal');
    expect(en.themeCrimson, 'Crimson');
    expect(en.preview, 'Preview');
    expect(en.save, 'Save');
